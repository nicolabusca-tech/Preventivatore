...
if [[ "$APP_DIR" == *"backup"* ]] || [[ "$APP_DIR" == *"preventivatore_backup"* ]]; then
  echo ""
  echo "================================================"
  echo "  ERRORE: stai avviando dalla cartella BACKUP"
  echo "  Cartella: $APP_DIR"
  echo ""
  echo "  Avvia invece lo script dentro la cartella principale:"
  echo "  .../preventivatore/avvia-preventivatore.command"
  echo "================================================"
  echo ""
  exit 1
fi
...
if [ ! -f "prisma/schema.prisma" ] || ! grep -q "model DiscountCode" "prisma/schema.prisma"; then
  echo ""
  echo "================================================"
  echo "  ATTENZIONE: questa sembra una versione vecchia"
  echo "  (manca 'model DiscountCode' in prisma/schema.prisma)"
  echo ""
  echo "  Se hai due cartelle (preventivatore e preventivatore_backup_v1),"
  echo "  avvia SEMPRE quella principale aggiornata."
  echo "================================================"
  echo ""
fi
