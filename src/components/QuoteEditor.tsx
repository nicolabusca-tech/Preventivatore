...
export function QuoteEditor({ initial }: Props) {
  ...
  // Credito Metodo Cantiere: leva commerciale on/off.
  // Default UI = false sui preventivi NUOVI: il commerciale lo accende solo
  // se decide di usarlo come bonus di trattativa. Sui preventivi gia' salvati
  // (initial presente) leggiamo lo stato persistito.
        ...
        <div className="lg:sticky lg:top-20 lg:max-h-[calc(100vh-6rem)] lg:overflow-auto lg:overscroll-contain">
          ...
          <div className="space-y-2 text-sm">
            ...
            {/* Toggle Credito Metodo Cantiere: leva commerciale on/off.
               Visibile solo se c'è almeno una voce in preventivo (altrimenti
               non c'è nulla su cui calcolare). Default UI = false: si accende
               caso per caso quando il commerciale vuole offrirlo come bonus. */}
            {selected.size > 0 && (
              <div
